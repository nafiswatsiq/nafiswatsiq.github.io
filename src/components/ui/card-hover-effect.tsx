          ...
          >
            ...
            <Card>
              <img
                ...
                className="rounded-xl w-full object-cover mb-4 border border-slate-700"
              />
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full overflow-hidden bg-black border border-gray-600 dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}
    >
      <div className="top-3 left-4 absolute flex space-x-2 z-50">
        <div className="bg-red-700 w-3 h-3 rounded-full"></div>
        <div className="bg-yellow-700 w-3 h-3 rounded-full"></div>
